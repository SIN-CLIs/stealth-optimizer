# AGENTS.md — Agenten-Anleitung (stealth-optimizer)
...
4. Doc-Health checken: `python3 /Users/jeremy/dev/stealth-runner/scripts/check_doc_health.py --repo stealth-optimizer`
